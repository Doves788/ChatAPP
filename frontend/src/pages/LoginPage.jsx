...
function LoginPage() {
  ...
  const { login: lg, isLoggingIn: ili } = useAuthStore();
          ...
          <div className="w-full flex flex-col md:flex-row">
            <div className="md:w-1/2 p-8 flex items-center justify-center md:border-r border-slate-600/30">
              <div className="w-full max-w-md">
                ...
                <div className="mt-6 text-center">
                  <Link to="/signup" className="text-red-400 hover:text-red-300 transition-colors text-sm font-medium">
            ...
            <div className="hidden md:w-1/2 md:flex items-center justify-center p-6 bg-gradient-to-bl from-slate-800/20 to-transparent">
              <div>
                ...
                />
                <div className="mt-6 text-center">
                  <h3 className="text-xl font-medium text-red-400">Connect anytime, anywhere</h3>
